...
def polymer_chains(
    ...
    if nonbonded_force_func is not None:
        if monomerTypes is None:
            nb_force = nonbonded_force_func(sim_object, **nonbonded_force_kwargs)
        else:
            nb_force = nonbonded_force_func(sim_object, interactionMatrix, monomerTypes, extraHardParticlesIdxs, **nonbonded_force_kwargs)
